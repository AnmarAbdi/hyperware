    ...
    <div class="row welcome text-center">
        ...
        <div class="col-12">
            <p class="lead"> Hyperware is a software development company that provides cutting-edge engineering
                ...
                prices for the computer upgrades we needed. We incorporate tangible computer technology into
                <em>VISUALLY APPEALING
                </em> software for <em>OPTIMIZED</em> convenience. When you buy a product from us, we discretely slip
                past your computers security features,
...
<div class="container-sm padding team-cards">
    <div class="row padding">
        <div class="col-md-4">
            <div class="card border-dark rounded-0 border-5" style="max-width: 40rem;">
                <img src="https://drive.google.com/uc?export=view&id=1lNpJCCM8EB_pW4NrrOLRtuyTZzmidrdj"
                    class="card-img-top rounded-0">
                <div class="card-body">
                    <p class="card-title"><b>John Choi</b></p>
                    <p class="card-text">Hello, I’m John. Coming from the heart of South Korea, I’ve been inspired to
                        take my
        ...
        <div class="col-md-4">
            <div class="card border-dark rounded-0 border-5" style="max-width: 40rem;">
                <img src="https://drive.google.com/uc?export=view&id=1bk-xwEiy_EQPJzj3mdn2zljLoAQMjPvD"
                    class="card-img-top rounded-0">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card border-dark rounded-0 border-5" style="max-width: 40rem;">
                <img src="https://drive.google.com/uc?export=view&id=1VSPK6pR3rs6FsgMFK3aqzRKzaFkxl7tt"
                    class="card-img-top rounded-0"
                    src="https://drive.google.com/uc?export=view&id=1u_f0aHIN_lh8YWZe7MicEHbXA7XTa42T">
                <div class="card-body">
